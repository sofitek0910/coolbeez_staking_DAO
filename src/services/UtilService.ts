...
export const getErc721Metadata = async (tokenUri: string) => {
  ...
  try {
    ...
    switch(name) {
      case '1':
        metadata.data.attributes[0].trait_type = 'Background_Common'
        break;
      case '2':
        metadata.data.attributes[0].trait_type = 'Background_Queen'
        break;
      case '3':
        metadata.data.attributes[0].trait_type = 'Background_Common'
        break;
      case '4':
        ...
        break;
      case '5':
        metadata.data.attributes[0].trait_type = 'Background_Naked'
        break;
      case '6':
        metadata.data.attributes[0].trait_type = 'Background_Queen'
        break;
      ...
      case '8':
        ...
        break;
      case '9':
        metadata.data.attributes[0].trait_type = 'Background_Solo'  
        break;
      default:
        metadata.data.attributes[0].trait_type = 'Background_Common'
    }
